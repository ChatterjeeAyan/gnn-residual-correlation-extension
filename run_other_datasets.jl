...
if inductive
    ...
    #run_dataset("sexual_2", [], sign_accuracy, regressor, correlation, inductive);
    #run_dataset("sexual_3", [], sign_accuracy, regressor, correlation, inductive);
    run_dataset("twitch_DE_true_8", [], R2, regressor, correlation, inductive);
    run_dataset("twitch_ENGB_true_8", [], R2, regressor, correlation, inductive);
    run_dataset("twitch_ES_true_8", [], R2, regressor, correlation, inductive);
    run_dataset("twitch_FR_true_8", [], R2, regressor, correlation, inductive);
    run_dataset("twitch_RU_true_8", [], R2, regressor, correlation, inductive);
end
